...
pub struct TranslateI18N {
    ...
    pub activated_modules: &'static str,
    ...
    pub delete_tag_w_name: &'static str,
    pub delete_user_w_name: &'static str,
    pub deleted_k_post: &'static str,
    pub deleted_posts: &'static str,
    pub description: &'static str,
    pub device: &'static str,
    pub disk_at_w_used: &'static str,
    pub disk_size_w_used_total_u1_u2: &'static str,
    pub disk_size_w_used_free_total_u1_u2_u3: &'static str,
    pub disk_usage: &'static str,
    pub disk_usage_w_unit: &'static str,
    pub documentation: &'static str,
    pub domain_cant_be_changed_in_development_mode: &'static str,
    pub domain_k_web: &'static str,
    pub download: &'static str,
    pub download_k_noun: &'static str,
    ...
    pub edit_tag_w_name: &'static str,
    ...
    pub err_default_language_cant_be_deleted: &'static str,
    pub err_featured_image_is_not_image: &'static str,
    pub err_field_is_not_lang_code: &'static str,
    pub err_file_title_already_exists: &'static str,
    ...
    pub err_user_is_not_admin: &'static str,
    pub err_user_not_logged_in: &'static str,
    pub err_uuid_is_not_valid: &'static str,
    ...
    pub err_wrong_domain: &'static str,
    pub err_wrong_email: &'static str,
    pub err_wrong_file_id: &'static str,
    pub err_wrong_file_title: &'static str,
    ...
    pub err_wrong_tag_id: &'static str,
    ...
    pub external_referrals: &'static str,
    pub faq: &'static str,
    ...
    pub in_the_last_month: &'static str,
    ...
    pub last_30_days_month: &'static str,
    pub last_365_days_year: &'static str,
    pub last_7_days_week: &'static str,
    pub last_start_w_date: &'static str,
    pub last_update: &'static str,
    pub login_k_noun: &'static str,
    pub login_k_verb: &'static str,
    pub logout_k_verb: &'static str,
    pub memory_k_ram: &'static str,
    pub memory_usage_percent: &'static str,
    pub menu: &'static str,
    pub menus: &'static str,
    pub modules: &'static str,
    pub n_days_w_time: &'static str,
    pub n_hours_w_time: &'static str,
    pub n_minutes_w_time: &'static str,
    pub n_months_w_time: &'static str,
    pub n_posts: &'static str,
    pub n_results_of_m: &'static str,
    pub n_seconds_w_time: &'static str,
    pub n_visitors_w_n: &'static str,
    pub n_years_w_time: &'static str,
    pub name: &'static str,
    ...
    pub network_w_unit: &'static str,
    pub new_category: &'static str,
    pub new_domain_k_web: &'static str,
    ...
    pub number_of_visits: &'static str,
    pub one_day: &'static str,
    pub one_hour: &'static str,
    pub one_minute: &'static str,
    pub one_month: &'static str,
    pub one_result_of_m: &'static str,
    pub one_second: &'static str,
    pub one_year: &'static str,
    ...
    pub tukosmo_w_version: &'static str,
    ...
    pub update_is_not_necessary: &'static str,
    pub update_tukosmo_to_w_version: &'static str,
    pub updated_k_server: &'static str,
    pub updated_k_tukosmo: &'static str,
    pub upload_file: &'static str,
    pub upload_k_noun: &'static str,
    ...
    pub used_k_disk: &'static str,
    pub users: &'static str,
    pub view_all: &'static str,
    pub visit_website: &'static str,
    pub visitors: &'static str,
    pub visits: &'static str,
    pub warning_domain_paragraph: &'static str,
    ...
    pub youll_receive_any_expiry_notices_of_tls_certificates: &'static str,
    pub your_account_has_been_successfully_updated: &'static str,
    pub your_current_domain_is_w_domain: &'static str,
    ...
    pub your_tukosmo_config_has_been_successfully_updated: &'static str,
    pub your_website_categories_were_successfully_updated: &'static str,
    ...
    pub your_website_tags_were_successfully_updated: &'static str,
