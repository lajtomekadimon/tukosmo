...
pub const MSG_ES: TranslateI18N = TranslateI18N {
    ...
    domain_cant_be_changed_in_development_mode:
        "El dominio no se puede cambiar en modo desarrollo.",
    domain_k_web:
        "Dominio",
    download:
        "Descargar",
    ...
    err_default_language_cant_be_deleted:
        "El idioma por defecto no puede eliminarse; \
        elige otro idioma por defecto primero.",
    ...
    err_some_wrong_i18n_user_name:
        "Algunos de los nombres del usuario para cada idioma no son válidos.",
    ...
    png_image_of_at_least_192x192:
        "imagen PNG de al menos 192x192 píxeles",
    posts:
        "Entradas",
    post_s_body:
    ...
    update_is_not_necessary:
        "Actualizar no es necesario.",
    update_tukosmo_to_w_version:
        "Actualizar Tukosmo a la versión {version}",
    updated_k_server:
        "Actualizado",
    updated_k_tukosmo:
        "Actualizado",
    ...
    website:
        "Página web",
    website_subtitle:
        "Subtítulo de la página web",
    website_subtitle_in_the_new_language:
        "Subtítulo de la página web (en el nuevo idioma)",
    website_title:
    ...
    your_tukosmo_config_has_been_successfully_updated:
        "La configuración de Tukosmo ha sido actualizada con éxito.",
