...
pub fn ra_users_edit_w_id(
    lang_code: &str,
    id: &i64,
) -> String {
    "/{lang}/admin/users/edit?id={id}"
        .replace("{lang}", lang_code)
        .replace("{id}", &id.to_string())
}

#[derive(Clone, Debug, ToSql, FromSql)]
pub struct AgiUsersEdit {
    pub req: types::AdminRequest,
    pub id: i64,
}

impl QueryFunction for AgiUsersEdit {
    fn query(&self) -> &str {
        "SELECT aha_g_users_edit($1)"
    }
}

#[derive(Clone, Debug, ToSql, FromSql)]
pub struct AgoUsersEdit {
