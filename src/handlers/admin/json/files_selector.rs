...
use crate::i18n::t::t;
use crate::templates::admin::json::files_selector::FilesSelector;
...
pub struct FilesSelectorAJRequest {
    pub req: types::AdminRequest,
    pub results_per_page: i64,
    pub page: i64,
}

impl QueryFunction for FilesSelectorAJRequest {
    fn query(&self) -> &str {
        "SELECT awaj_files_selector($1)"
    }
}

#[derive(Clone, Debug, ToSql, FromSql)]
pub struct FilesSelectorAJResponse {
    ...
    match user_request(req, id) {
        ...
        Ok(user_req) => match query_db(
            ...
            Ok(row) => {
                ...
                let q: FilesSelectorAJResponse = row.get(0);
