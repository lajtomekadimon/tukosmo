...
CREATE TYPE "FilesSelectorAJRequest" AS (
    req "AdminRequest",
    results_per_page BIGINT,
    page BIGINT
);

CREATE TYPE "FilesSelectorAJResponse" AS (
    data "AdminDataDB",
    files "FileDB"[],
    results_per_page BIGINT,
    page BIGINT,
...
CREATE OR REPLACE FUNCTION awaj_files_selector(
    r "FilesSelectorAJRequest"
)

RETURNS "FilesSelectorAJResponse"
